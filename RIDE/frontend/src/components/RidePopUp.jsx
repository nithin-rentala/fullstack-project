        ...
        <div>
            ...
            <div className='flex flex-col justify-between items-center gap-3'>
                ...
                <div className='w-full flex justify-between'>
                    <button onClick={() => {
                        setRidePopUpPanel(false)
                    }} className=' flex items-center justify-center bg-gray-300 text-black py-3 px-10 rounded  font-semibold '>Ignore</button>
                    <button onClick={() => {
                        setConfirmRidePopUpPanel(true);
                    }} className=' flex items-center justify-center bg-[#10b461] text-white py-3 px-10 rounded  font-semibold '>Accept</button>
                </div>
