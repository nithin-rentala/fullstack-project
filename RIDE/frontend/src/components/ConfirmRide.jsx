...
function ConfirmRide({ setConfirmRidePanel, setLookingForDriver }) {
    return (
        <div>
            <h4 onClick={() => { setConfirmRidePanel(false) }} className='text-center w-full  font-normal -mt-3 '><i className="ri-arrow-down-wide-line text-3xl text-gray-500"></i></h4>
            <h3 className='text-2xl font-bold mb-5'>Confirm Ride</h3>
            ...
            <div className='flex flex-col justify-between items-center gap-3'>
                ...
                } className=' flex items-center justify-center bg-[#10b461] text-white py-2 px-4 rounded  font-semibold w-80 '>Confirm</button>
            </div>
